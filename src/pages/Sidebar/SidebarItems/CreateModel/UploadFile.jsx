...
const UploadFile = () => {
    ...
    const setImage = useUploadFileStore((s)=>s.setImage);
    ...
    //useUploadFileStore
  return (
    <Box gap={3}  alignItems={'center'} justifyContent={'center'} display={'flex'} flexDirection='column' >
    <Input
        type="file"
        ref={fileInputRef}
        display={'none'} 
    ...
    <Button h={8} backgroundColor={'blue.500'} _hover={{backgroundColor:'#1877F2'}}   onClick={handleButtonClick}>
